        ...
        <div className="container max-w-7xl w-full mt-20 flex flex-col space-y-20">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-y-4 md:gap-4 w-full">
              ...
              <div
                className={`col-span-2 md:col-span-1 flex flex-col justify-between xl:col-span-2 relative cursor-pointer bg-sky-600/10 dark:hover:border-sky-500 transition-all duration-300 group rounded border-2 border-sky-600/20 p-4 min-h-64`}
              >
