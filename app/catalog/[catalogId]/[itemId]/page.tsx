      ...
      <div className="container max-w-7xl w-full my-10">
        <div className="w-full flex flex-col max-w-2xl p-4 mx-auto">
          ...
          <p className="text-md mt-2 text-slate-400 dark:text-slate-400 transition-all duration-300">
            ...
            eveniet totam provident magnam temporibus, ratione cum facilis ipsam
            quia mollitia consequatur maiores quae dolores cupiditate. Maxime
            numquam fuga repudiandae recusandae!
            <br />
            <br />
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Itaque
            consequuntur asperiores dolore quas dignissimos, necessitatibus hic
            et reprehenderit obcaecati voluptates tenetur, blanditiis
            distinctio!
            <br />
            <br />
