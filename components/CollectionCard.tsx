...
export default function CollectionCard(item: Collection, colSpan: string) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 flex h-full w-full items-end bg-gradient-to-t from-slate-900/10 to-slate-900/0 p-5 transition-all duration-300 dark:from-slate-900">
